...
Download the package or copy the code from Blade_Directive.json , Session_Methods.json files and paste it to Blade.json & Router_Methods.json, Database_Query_Builder.json, Eloquent_Orm.json, Loop_Variables.json, Validation.json, Table_Column_Types.json, Eloquent.json to php.json file.
